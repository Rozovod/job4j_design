...
public class AnalizeTest {
    ...
    public void whenNotChanged() {
        ...
        assertThat(Analize.diff(previous, current), is(new Info(0, 0, 0)));
    }
    ...
    public void whenOneChanged() {
        ...
        assertThat(Analize.diff(previous, current), is(new Info(0, 1, 0)));
    }
    ...
    public void whenOneDeleted() {
        ...
        assertThat(Analize.diff(previous, current), is(new Info(0, 0, 1)));
    }
    ...
    public void whenOneAdded() {
        ...
        assertThat(Analize.diff(previous, current), is(new Info(1, 0, 0)));
    }
    ...
    public void whenAllChanged() {
        ...
        assertThat(Analize.diff(previous, current), is(new Info(1, 1, 1)));
    }
}